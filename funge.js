	...
	function blockpile(blocks, n) {
		...
		while (true) {
			...
			if (n.meta.op == 0) {
				...
				varint(block, n.arg);
				block.push(0x36, 0, 0, 0x20, 0, 0x41, 4, 0x6a, 0x21, 0);
			} else if (n.meta.op == 1) {
				...
				block.push(0x41, 0, 0x28, 0, 0, 0x22, 1, 0x41, 0, 0x4f, 0x20, 1, 0x41);
				varint(block, 2560);
				block.push(0x49, 0x71, 0x04, 0x40);
				block.push(0x41, 0, 0x20, 1, 0x41, 2, 0x74);
				block.push(0x28, 0);
				varuint(block, 0xce00);
				block.push(0x36, 0, 0, 0x05, 0x41, 0, 0x41, 0, 0x36, 0, 0, 0x0b);
				...
				block.push(0x20, 0, 0x45, 0x04, 0x40, 0x41, 0, 0x41, 0, 0x36, 0, 0, 0x0b);
				block.push(0x41, 4, 0x41, 0, 0x28, 0, 0, 0x36, 0, 0, 0x41, 0, 0x41, 0, 0x36, 0, 0, 0x0b);
				block.push(0x41, 8, 0x41, 4, 0x28, 0, 0, 0x36, 0, 0, 0x41, 4, 0x41, 0, 0x28, 0, 0, 0x36, 0, 0, 0x41, 0, 0x41, 0, 0x36, 0, 0, 0x41, 12, 0x21, 0, 0x0b);
