						...
						if (dep < 2) {
							switch (n.arg) {
								...
								case 0x4a: // if sp == 4, *0 = 0 > *0
									block.push(0x05, 0x41, 0, 0x41, 0, 0x41, 0, 0x28, 2, 0, 0x4a, 0x36, 2, 0);
									break;
							}
							block.push(0x0b);
							if (dep == 0) {
					...
					if (n.depi) {
						...
						if (n.arg & 0x1000) {
							...
							if (dep < 3) {
								...
								if (dep < 2) block.push(0x41, 0, 0x41, 0, 0x29, 2, 0, 0x42, 32, 0x86, 0x37, 2, 0, 0x0b);
								block.push(0x41, 4, 0x41, 0, 0x29, 2, 0, 0x37, 2, 0, 0x41, 0, 0x41, 0, 0x36, 2, 0, 0x41, 12, 0x21, 0, 0x0b);
							}
